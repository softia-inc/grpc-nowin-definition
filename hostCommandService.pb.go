...
var file_hostCommandService_proto_rawDesc = []byte{
	...
	,
...
var file_hostCommandService_proto_depIdxs = []int32{
	0, // 0: nowin.HostCommandService.Create:input_type -> nowin.HostCommandCreateFirstRequest
	1, // 1: nowin.HostCommandService.Create:output_type -> nowin.HostCommandCreateFirstResponse
...
type HostCommandServiceClient interface {
	Create(ctx context.Context, in *HostCommandCreateFirstRequest, opts ...grpc.CallOption) (*HostCommandCreateFirstResponse, error)
}
...
func (c *hostCommandServiceClient) Create(ctx context.Context, in *HostCommandCreateFirstRequest, opts ...grpc.CallOption) (*HostCommandCreateFirstResponse, error) {
...
type HostCommandServiceServer interface {
	Create(context.Context, *HostCommandCreateFirstRequest) (*HostCommandCreateFirstResponse, error)
}
...
func (*UnimplementedHostCommandServiceServer) Create(context.Context, *HostCommandCreateFirstRequest) (*HostCommandCreateFirstResponse, error) {
...
func _HostCommandService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HostCommandServiceServer).Create(ctx, req.(*HostCommandCreateFirstRequest))
	}
