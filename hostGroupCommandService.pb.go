...
type HostGroupCommandCreateRequest struct {
	...
	HomePageURL     string `protobuf:"bytes,6,opt,name=homePageURL,proto3" json:"homePageURL,omitempty"`
}
...
var file_hostGroupCommandService_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x0b, 0x68, 0x6f, 0x6d, 0x65, 0x50, 0x61, 0x67, 0x65, 0x55, 0x52, 0x4c, 0x22, 0x46,
