...
type HostGroupCommandCreateRequest struct {
	...
	TelephoneNumber1 int32  `protobuf:"varint,4,opt,name=telephoneNumber1,proto3" json:"telephoneNumber1,omitempty"`
	TelephoneNumber2 int32  `protobuf:"varint,5,opt,name=telephoneNumber2,proto3" json:"telephoneNumber2,omitempty"`
	TelephoneNumber3 int32  `protobuf:"varint,6,opt,name=telephoneNumber3,proto3" json:"telephoneNumber3,omitempty"`
...
func (x *HostGroupCommandCreateRequest) GetTelephoneNumber1() int32 {
	if x != nil {
...
func (x *HostGroupCommandCreateRequest) GetTelephoneNumber2() int32 {
	if x != nil {
...
func (x *HostGroupCommandCreateRequest) GetTelephoneNumber3() int32 {
	if x != nil {
...
var file_hostGroupCommandService_proto_rawDesc = []byte{
	...
	0x72, 0x31, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x10, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x68,
	...
	0x6f, 0x6e, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x33, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05,
